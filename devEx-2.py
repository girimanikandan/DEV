# Step 1: Create initial email data and save to CSV
import pandas as pd
...
# Step 2: Import and load data for EDA
...
# Step 4: Distribution of Email Lengths
plt.figure(figsize=(10, 6))
sns.histplot(data=df, x='email_length', bins=30, kde=True, color='skyblue')
...
# Step 6: Emails over Time
df['year_month'] = df['timestamp'].dt.to_period('M')
email_activity = df.groupby('year_month').size()

plt.figure(figsize=(12, 6))
email_activity.plot(kind='line', marker='o', color='orange')
